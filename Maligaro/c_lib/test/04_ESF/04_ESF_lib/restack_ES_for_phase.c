...
{
fprintf(my_input->out_logfile,"---> Restack E.W. ");
	...
	{
		fprintf(my_input->out_logfile," if 0 record is needed to restack E.W. then we use everytrace with the same weight to stack for one \n");
