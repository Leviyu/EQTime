...
struct new_INPUT
{
    ...
    double DIST_MASK_BEG;
    double DIST_MASK_END;
	double SNR_CUT;
	double CCC_CUT;
...
struct new_RECORD
{
	...
	int npts_SS_peak_zero;	            // the npts difference between SS /ScSScS peak and the zero 
                                            //point in front of peak
