...
{
	// initiate my_input
	my_input->EQ = (char*)malloc(sizeof(char)*20);
	my_input->filter_flag = (char*)malloc(sizeof(char)*20);
	...
	my_input->PHASE = (char*)malloc(sizeof(char)*20);
	my_input->COMP = (char*)malloc(sizeof(char)*20);
